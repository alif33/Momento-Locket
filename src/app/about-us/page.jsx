            ...
            <div className="w-11/12 sm:w-11/12 md:w-7/12 mx-auto">
                ...
                <div>
                    <ul className="list-disc">
                        <li className="text-[#747067] font-semibold text-base">Patent by Chi Huynh, PT NO. https://<a className="text-[#4C69FF]" href="https://patents.google.com/patent/US20190122010A1">patents.google.com/patent/US20190122010A1</a> , <a className="text-[#4C69FF]" href="https://patents.google.com/patent/US10108900B2">https://patents.google.com/patent/US10108900B2</a> and 5 other utility patent. Contact us for more info.</li>
                    </ul>
                </div>
            </div>
        </div>
